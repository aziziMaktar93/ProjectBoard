...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('workspaces/archived', [WorkspaceController::class, 'archived'])->name('workspaces.archived');
    Route::get('workspaces/{workspace}', [WorkspaceController::class, 'show'])->name('workspaces.show');
    Route::patch('workspaces/{workspace}', [WorkspaceController::class, 'update'])->name('workspaces.update');
    Route::patch('workspaces/{workspace}/archive', [WorkspaceController::class, 'archive'])->name('workspaces.archive');
    Route::patch('workspaces/{workspace}/restore', [WorkspaceController::class, 'restore'])->name('workspaces.restore');
